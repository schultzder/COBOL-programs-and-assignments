      ...
      ******************************************************************
      * Purpose of the Program: Create an updated sales file from the
      * sorted file by using a transaction file sorted in ascending 
      * sequence by customer number  
      *
      *  Input File:
      *   1-4   Client Number
      *   5-29  Client Name
      ...
      *
      *  Output File:
      *   The report will output a new sales file and an update report 
      *      
      *
      *   Infile  =  C:\COBOL\sortedDAT.txt
      *   Infile  =  C:\COBOL\sortedInput.txt
      *   Outfile =  C:\COBOL\out_new_mst.txt
      *   Outfile =  C:\COBOL\new_mstRPT.txt
      *   Outfile =  C:\COBOL\transactionFile.txt
      ******************************************************************
      ...
      * Select statment for the sorted transaction file
       
       SELECT SORTED-IN-TRANS-FILE
              ASSIGN TO UT-SYS-TRANSVFILE
              ORGANIZATION IS LINE SEQUENTIAL. 
              
      * Select statment for the original transaction file       
      ...
      ******************************************************************
      * Performs the update test for when a record is deleted
      ****************************************************************** 
       400-UPDATE-TEST.
           EVALUATE TRUE
      ...
      ******************************************************************
      * Writes the detail to the output record
      ****************************************************************** 
       500-WRITE-DETAILS.
      ...
      ******************************************************************
      * Writes the detai lfor deleting a file
      ****************************************************************** 
      ...
      ******************************************************************
      * Writes the detail for updating a file
      ****************************************************************** 
      ...
      ****************************************************************
      * Writes the detail for adding a record to a file
      ******************************************************************       
       550-ADD-RTN.
      ...
      ******************************************************************
      * Writes the correct detail for if you try to delete a record 
      * doesnt exist 
      ****************************************************************** 
       560-ERROR-CODE.
      ...
      ******************************************************************
      * Writes the correct detail for if a record does not exist and 
      ...
      ******************************************************************
      * Writes the correct detail for if a record already exists and you
      ...
      ******************************************************************
      * Moves all the attributes into the correct spots to write the 
      * old record  
      ****************************************************************** 
       650-WRITE-OLD-REC.
           MOVE O-CLIENT-NO TO A-CLIENT-NO
      ...
      ******************************************************************
      * Moves all the attributes to the correct spots and performs the 
      * computations to write the new output record 
      ****************************************************************** 
       700-UPDATE-RECORD.
           MOVE O-CLIENT-NO TO A-CLIENT-NO
           MOVE O-CLIENT-NAME TO A-CLIENT-NAME
